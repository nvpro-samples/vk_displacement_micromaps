...
#define MICRO_BTRI_VTX_COUNT   (MICRO_BTRI_MAX_MESHLET_PARTS * MICRO_MAX_LEVELS * MICRO_MAX_LEVELS * MICRO_MAX_FORMATS * MICRO_MESHLET_VERTICES)
#define MICRO_BTRI_VTX_OFFSET(partID, targetSubdiv, baseSubdiv, formatIdx)  \
     (((partID) + \
        (MICRO_BTRI_MAX_MESHLET_PARTS * (targetSubdiv)) + \
        (MICRO_BTRI_MAX_MESHLET_PARTS * MICRO_MAX_LEVELS) * (baseSubdiv) \
...
#define MICRO_MTRI_VTX_COUNT   (MICRO_MAX_MTRI_MESHLET_PARTS * MICRO_MAX_LEVELS * MICRO_MAX_LEVELS * MICRO_PART_VERTICES_STRIDE)
#define MICRO_MTRI_VTX_OFFSET(partID, targetSubdiv, baseSubdiv)  \
     ( ((partID) + \
        (MICRO_MAX_MTRI_MESHLET_PARTS * (targetSubdiv)) + \
        (MICRO_MAX_MTRI_MESHLET_PARTS * MICRO_MAX_LEVELS) * (baseSubdiv)) \
...
#define MICRO_MTRI_DESCENDS_INDEX(blockTri, format)   ((blockTri) + (MICRO_FORMAT_MAX_TRIANGLES * MICRO_FORMAT_MAX_LEVELS) * (format))
