...
class MicromeshMicroTriangleDecoderVK
{
public:
  MicromeshMicroTriangleDecoderVK(MicromeshSetCompressedVK& microSet)
      : m_micro(microSet)
  {
  }

  // all must have BARY_BASE_FLAG_UNIFORM_SUBPRIMITIVE_BLOCK_FORMATS_BIT set
  bool init(ResourcesVK& res, const MeshSet& meshSet, const BaryAttributesSet& barySet, bool withAttributes, bool useIntrinsic, uint32_t numThreads);
